...
| `/ux` | UI/UX Design Document |
| `/appflow` | Application Flow Document |
| `/schema` | Backend Schema Document |
| `/impl` | Implementation Plan |
| `/all-docs` | All 6 documents |
...
```
/prd MyApp is a SaaS invoicing tool for freelancers using Next.js + Supabase
```
